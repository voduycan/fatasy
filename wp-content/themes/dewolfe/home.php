...
<section class="our-camp">
	...
	<div class="row">
		<div class="card-deck">
		  <div class="card">
		    <img class="card-img-top" src="<?php bloginfo('template_url'); ?>/data/image/png/section3_learn.png)" alt="Card image cap">
		    <h2>learn</h2>
		    <div class="card-body">
		      	<ul>
		      		<li>Block chain</li>
		  ...
		  <div class="card">
		    <img class="card-img-top" src="<?php bloginfo('template_url'); ?>/data/image/png/section3_interact.png)" alt="Card image cap">
		    <h2>interact</h2>
		    <div class="card-body">
		  ...
		  <div class="card">
		    <img class="card-img-top" src="<?php bloginfo('template_url'); ?>/data/image/png/section3_explore.png)" alt="Card image cap">
		    <h2>explore</h2>
		    <div class="card-body">
